...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id EF7592B2F32
	for <lists+osst-users@lfdr.de>; Sat, 14 Nov 2020 18:46:25 +0100 (CET)
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=TGcWZVgvWr/PTrXik9VSimPMARDWMmlZ79/4V0fBCMs=; b=PvC/KJebOMopuEpF8b+Mh7MH+c
 kbjQE3TQbzdm5gPigVToAQGF6NvXbyyYdzZMgiPF3a88ilJ6vwsFeL+o6MqPCuVQ2BmGoeuEweUpf
 zoePNEBUyoGh0AT2xF68wW9OLBdmfOxoHZvFr9/nybte/S92CUR0JyslUKVIznPXNR5k=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=TGcWZVgvWr/PTrXik9VSimPMARDWMmlZ79/4V0fBCMs=; b=L
 fuDbCTxiQ1yIQUjHSBqyZBndkOfJ3AvApOeZ6VOORgEBW7QDg9X0+APiH9yFH18uZE0lm/Il4lXmJ
 kQ5ijiD5QksH6DAvBXvAEPmAGYXVIOexsjLWAkjw6Oea05Yy74DmUzOum2omwExWQThhsiwPuoAp2
 fVzf0upSQvk3udvA=;
Received: from ip.sgp.pillogistics.com ([203.116.38.243])
 ...
 (Exim 4.92.2) id 1kdyJG-00Bbph-KU
...
Message-Id: <8eb11c$tutnk@ip.sgp.pillogistics.com>
...
X-Headers-End: 1kdyJG-00Bbph-KU
...
Content-Type: multipart/mixed; boundary="===============4017249889607617731=="
Errors-To: osst-users-bounces@lists.sourceforge.net

--===============4017249889607617731==
Content-Type: multipart/report; report-type=delivery-status; boundary="1ttIg.5j1DxWPwQ.3QwitdGb6gd.9C7EV4v"

--1ttIg.5j1DxWPwQ.3QwitdGb6gd.9C7EV4v
content-type: text/plain;
    charset="utf-8"
Content-Transfer-Encoding: quoted-printable

The following message to <869453764@qq.com> was undeliverable.
...
Final-Recipient: rfc822;869453764@qq.com
Action: failed

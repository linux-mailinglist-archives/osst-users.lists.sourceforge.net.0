...
Received: from lists.sourceforge.net (unknown [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 759EF6C501F
	for <lists+osst-users@lfdr.de>; Wed, 22 Mar 2023 17:09:21 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1pf11a-0003Jc-8l
	for lists+osst-users@lfdr.de;
	Wed, 22 Mar 2023 16:09:20 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <mariann.rivas@consultores-rh.com>)
 id 1pf11Z-0003JW-N9 for osst-users@lists.sourceforge.net;
 Wed, 22 Mar 2023 16:09:19 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=JJLR4COJGN6hz8Af6H6RvzE73i7uBPUJcR2+UPJFBT8=; b=mgrYVlvLO/wVlQZJ2GdAqTiYY6
 b1GUswc1+HB0xwc2wA5uvcxHo3kzTYJUY10+86b752qUJVxgoUfugzK6Ep/Oo8VteSb4hqu+KLCNY
 ri59apH2NXsSrtdsdeJnxwExd7f6SwzMM9FuVVk6kVVyw+mke2+xoAdbnZP/UjciOFa4=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=JJLR4COJGN6hz8Af6H6RvzE73i7uBPUJcR2+UPJFBT8=; b=H1UXskkkR/zr
 UBGsZ7sBbepMrtpin81ncd4K7LCxPXCnqRcwu+Qe0V93xUSAsseAYSlrsFfrYq0h5Q7KIho+sMVyv
 egi2FemoW21MO9QWUsqPiOh6KYjcU5wPttVuTUERSgAazJbah6VXGSuJ+6JM1Jh7hJdcY5PO86bgc
 osNZw=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pf11a-0002q5-5e for osst-users@lists.sourceforge.net;
 Wed, 22 Mar 2023 16:09:19 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=JJLR4COJGN6hz8Af6H6RvzE73i7uBPUJcR2+UPJFBT8=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=JJLR4COJGN6hz8Af6H6RvzE73i7uBPUJcR2+UPJFBT8=;
 b=
From: Mariann Rivas <mariann.rivas@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_djmPvzLc80lZ@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_djmPvzLc80lZ
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=omgjnmxk&token=lfgvv3sa
Feedback-ID: 287535:287535-4376:campaign:IPRPL
...
X-Headers-End: 1pf11a-0002q5-5e
...
Content-Type: multipart/mixed; boundary="===============4089517885428255114=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============4089517885428255114==
Content-Type: multipart/related;
 boundary="--==_mimepart_641b2825f3c6f_13f817827746c5844471";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_641b2825f3c6f_13f817827746c5844471
Content-Type: multipart/alternative;
 boundary="--==_mimepart_641b2825f3b3c_13f817827746c584434d";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_641b2825f3b3c_13f817827746c584434d
...
( https://tr220505813.consultores-rh.com/c/omgjnmxk/lfgvv3sa/bhwb1codf54 =
)
...
.com/c/omgjnmxk/lfgvv3sa/bhwb1codf54"><span lang=3D"ES-TRAD" style=3D"mso=
...
<img src=3D"https://tr220505813.consultores-rh.com/i/omgjnmxk/lfgvv3sa.gi=

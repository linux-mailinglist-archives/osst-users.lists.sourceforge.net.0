...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 61FB36AD02F
	for <lists+osst-users@lfdr.de>; Mon,  6 Mar 2023 22:27:39 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1pZIMs-0000PD-Gk
	for lists+osst-users@lfdr.de;
	Mon, 06 Mar 2023 21:27:37 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <luis.rodriguez@consultores-rh.com>)
 id 1pZIMr-0000P6-9h for osst-users@lists.sourceforge.net;
 Mon, 06 Mar 2023 21:27:36 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=PptetlS1GBERkIaHNz6Tr7AB1jobLcDG+fcyq3ylrxY=; b=Q0StqZ6Ccqm4L+zNua9E/5GTiq
 kC9vVltzdkKkeddQkUYpGeLD5a3DUy7GQySTfw1nbC3cq7e2+F1xMsdgcACZPfPQirRZofpg4BU30
 bVSf52PNMMKYGiJ6d6K7Db+g0ZLuQnRJV/11gtAtKFgwb+enY5FaEA0Y4v6wMbzggtH8=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=PptetlS1GBERkIaHNz6Tr7AB1jobLcDG+fcyq3ylrxY=; b=hI6pPfkclmJ4
 f3lRlSlh8itHq+hbSy76SW9nG14ZYXBnHdbKTLI73E+AYH/XObz2uOif+SLQmGrNHOscks8Y8qFtL
 i5VPodn+96btmDVHIhoRKHRbKhfMRMIEsw/t5H9nTbmaB/aP/J3fVSFCiE+9UIKm7aTvAu7sKbFsb
 m7StI=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pZIMp-001QZw-6a for osst-users@lists.sourceforge.net;
 Mon, 06 Mar 2023 21:27:36 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=PptetlS1GBERkIaHNz6Tr7AB1jobLcDG+fcyq3ylrxY=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=PptetlS1GBERkIaHNz6Tr7AB1jobLcDG+fcyq3ylrxY=;
 b=
From: =?UTF-8?B?THVpcyByb2Ryw61ndWV6?= <luis.rodriguez@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_3Xegw66C2kzR@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_3Xegw66C2kzR
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=6gxo8n1o&token=vk3z55ua
Feedback-ID: 287535:287535-4346:campaign:IPRPL
Date: Mon, 6 Mar 2023 21:27:35 +0000
X-Spam-Score: 3.4 (+++)
X-Spam-Report: Spam detection software, running on the system "util-spamd-2.v13.lw.sourceforge.com",
 ...
 Content preview:  Hola, seré breve. ¿Te has encontrado en una situación en
    la que tus empleados carecen de las habilidades necesarias para cumplir con
    las demandas de tu empresa? Sabemos que las organizaciones, siempre estamos
    en busc [...] 
 ...
 -0.1 DKIM_VALID_AU          Message has a valid DKIM or DK signature from
  ...
  0.1 DKIM_SIGNED            Message has a DKIM or DK signature, not necessarily
                             valid
X-Headers-End: 1pZIMp-001QZw-6a
Subject: [Osst-users] =?utf-8?q?Una_soluci=C3=B3n_de_aprendizaje_innovador?=
 =?utf-8?q?a_para_empresas?=
...
Content-Type: multipart/mixed; boundary="===============0191926766316993024=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============0191926766316993024==
Content-Type: multipart/related;
 boundary="--==_mimepart_64065abeef28b_13fc1706a6b4035737f9";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64065abeef28b_13fc1706a6b4035737f9
Content-Type: multipart/alternative;
 boundary="--==_mimepart_64065abeef0b1_13fc1706a6b4035736e";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64065abeef0b1_13fc1706a6b4035736e
...
=C2=BFTe has encontrado en una situaci=C3=B3n en la que tus empleados
carecen de las habilidades necesarias para cumplir con las
demandas de tu empresa? Sabemos que las organizaciones, siempre
estamos en busca de soluciones que nos permitan mejorar el
desempe=C3=B1o de los empleados y llevar a la empresa al =C3=A9xito.

Es por eso por lo que en Human Learning hemos creado una soluci=C3=B3n
de aprendizaje innovadora y eficaz que te ayudar=C3=A1 a lograr el
=C3=A9xito empresarial.

Nuestra plataforma de capacitaci=C3=B3n ofrece una amplia variedad de
cursos que se pueden adaptarse a las necesidades espec=C3=ADficas de
tu empresa u organizaci=C3=B3n.

Algunos de los beneficios que obtendr=C3=A1s al utilizar Human
Learning son:

* Acceso a un amplio cat=C3=A1logo de cursos grabados que se pueden
adaptar a las necesidades de tu empresa.

* Contenidos de alta calidad impartidos por expertos en diversas
=C3=A1reas del conocimiento.

* Capacitaci=C3=B3n que se puede realizar en cualquier momento y desde
cualquier lugar, sin importar la ubicaci=C3=B3n geogr=C3=A1fica de tus
empleados.

* Posibilidad de realizar seguimiento y evaluaci=C3=B3n del progreso
de capacitaci=C3=B3n de tus empleados en tiempo real.

* Certificados que avalan la formaci=C3=B3n y habilidades adquiridas
por tus empleados y que pueden ser utilizados como evidencia ante
tus clientes o socios comerciales.

En resumen, con Human Learning podr=C3=A1s dar a tus empleados la
oportunidad de desarrollar sus habilidades y conocimientos, lo
que resultar=C3=A1 en un equipo m=C3=A1s competente y motivado. Adem=C3=A1=
s,
obtendr=C3=A1s la tranquilidad de saber que tu empresa cuenta con un
...
contacto@psicosmart.pro?subject=3DInformaci%C3%B3n%20del%20tema:%20HumanL=
earning&body=3DMis%20datos%20son%0d%0a%0d%0aNombre%3a%0d%0aEmpresa%3a%0d%=
...
</style><![endif]--><title> Plan de capacitaci=C3=B3n 2023</title>
<style><!--
/* Font Definitions */
@font-face
...
/* List Definitions */
@list l0
	{mso-list-id:1149789398;
	mso-list-template-ids:1640013504;}
@list l0:level1
...
@list l0:level9
	...
	font-family:Symbol;}
@list l1
	{mso-list-id:1349021798;
	mso-list-type:hybrid;
	mso-list-template-ids:-717720602 134873089 -1 -1 -1 -1 -1 -1 -1 -1;}
@list l1:level1
	{mso-level-number-format:bullet;
	mso-level-text:=EF=82=B7;
...
<p class=3D"MsoNormal">=C2=BFTe has encontrado en una situaci=C3=B3n en l=
a que <b>tus empleados carecen de las habilidades necesarias para cumplir=
 con las demandas de tu empresa?</b> Sabemos que las organizaciones, siem=
pre estamos en busca de soluciones que nos permitan mejorar el desempe=C3=
=B1o de los empleados y llevar a la empresa al =C3=A9xito.</p>
<p></p>
<p class=3D"MsoNormal"></p>
<p>=C2=A0</p>
<p class=3D"MsoNormal">Es por eso por lo que en <b>Human Learning hemos c=
reado una soluci=C3=B3n de aprendizaje innovadora y eficaz</b> que te ayu=
dar=C3=A1 a lograr el =C3=A9xito empresarial. </p>
<p></p>
<p class=3D"MsoNormal">Nuestra plataforma de capacitaci=C3=B3n ofrece una=
 amplia variedad de cursos que se pueden adaptarse a las necesidades espe=
c=C3=ADficas de tu empresa u organizaci=C3=B3n. </p>
<p></p>
<p>=C2=A0Algunos de los beneficios que obtendr=C3=A1s al utilizar Human L=
earning son:</p>
<p></p>
<ul style=3D"margin-top:0cm" type=3D"disc">
<li class=3D"MsoListParagraph" style=3D"margin-left:-15.75pt;mso-list:l1 =
level1 lfo3">Acceso a un amplio cat=C3=A1logo de cursos grabados que se p=
ueden adaptar a las necesidades de tu empresa. <p></p>
</li>
<li class=3D"MsoListParagraph" style=3D"margin-left:-15.75pt;mso-list:l1 =
level1 lfo3">Contenidos de alta calidad impartidos por expertos en divers=
as =C3=A1reas del conocimiento. <p></p>
</li>
<li class=3D"MsoListParagraph" style=3D"margin-left:-15.75pt;mso-list:l1 =
level1 lfo3">Capacitaci=C3=B3n que se puede realizar en cualquier momento=
 y desde cualquier lugar, sin importar la ubicaci=C3=B3n geogr=C3=A1fica =
de tus empleados.<p></p>
</li>
<li class=3D"MsoListParagraph" style=3D"margin-left:-15.75pt;mso-list:l1 =
level1 lfo3">Posibilidad de realizar seguimiento y evaluaci=C3=B3n del pr=
ogreso de capacitaci=C3=B3n de tus empleados en tiempo real.<p></p>
</li>
<li class=3D"MsoListParagraph" style=3D"margin-left:-15.75pt;mso-list:l1 =
level1 lfo3">Certificados que avalan la formaci=C3=B3n y habilidades adqu=
iridas por tus empleados y que pueden ser utilizados como evidencia ante =
tus clientes o socios comerciales. <p></p>
</li>
</ul>
<p>En resumen, con Human Learning <b>podr=C3=A1s dar a tus empleados la o=
portunidad de desarrollar sus habilidades y conocimientos</b>, lo que res=
ultar=C3=A1 en un equipo m=C3=A1s competente y motivado. Adem=C3=A1s, obt=
endr=C3=A1s la tranquilidad de saber que <b>tu empresa cuenta con un pers=
onal bien capacitado.</b></p>
<p></p>
...
n da </span><a href=3D"mailto:contacto@psicosmart.pro?subject=3DInformaci=
%C3%B3n%20del%20tema:%20HumanLearning&amp;body=3DMis%20datos%20son%0d%0a%=
0d%0aNombre%3a%0d%0aEmpresa%3a%0d%0aTel%C3%A9fono%3a%0d%0aComentarios%3a%=
0d%0a%0d%0a%C2%A1Gracias!"><b><span lang=3D"ES">Clic aqu=C3=AD</span></b>=
<span lang=3D"ES">=C2=A0</span></a><span lang=3D"ES">y en breve te enviar=
=C3=A9 m=C3=A1s informaci=C3=B3n.<p></p></span></p>
<p class=3D"MsoNormal">Saludos.</p>
<p></p>
<p class=3D"MsoNormal"></p>
<p>=C2=A0</p>
...
st-language:ES-MX">: +52 33 1607 2089<br></span><span style=3D"mso-fareas=
t-language:ES-MX">=C2=A0<p></p></span></p>
</td>
...
" id=3D"_x0000_i1026" src=3D"https://tr220505813.consultores-rh.com/i/ddz=
z6xk0/7br_cuwv.gif"></span><span style=3D"mso-fareast-language:ES-MX"><p>=
</p></span></p>
<p class=3D"MsoNormal"><span style=3D"mso-fareast-language:ES-MX"><img bo=
rder=3D"0" width=3D"1" height=3D"1" style=3D"width:.0104in;height:.0104in=
" id=3D"_x0000_i1025" src=3D"https://tr220505813.consultores-rh.com/i/neq=
9qyj5/vunm7r-r.gif"></span><span style=3D"mso-fareast-language:ES-MX"><p>=
</p></span></p>
</div>
<img src=3D"https://tr220505813.consultores-rh.com/i/6gxo8n1o/vk3z55ua.gi=

...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 184D6CE7B47
	for <lists+osst-users@lfdr.de>; Mon, 29 Dec 2025 18:04:31 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=KY8JbZCuqvUDjegA9OJ63WovMewSFwHxmZ8dAZknVr4=; b=RJjKOStVXmPAiC6bacdLRb62Jg
	ODMj+7vXG7WN54vkHhQ3zcUEdQH9zQ0ZlgO8WbOnXHQoqW2RqW+pRyXUzangz8Vny3UQMqRNAE3nN
	JHIwmENOW16biSk45ja9PanjPR/AgxT+sRkB20Ulx1iUQ3+S0jAuaCfebm5fLc54QQJU=;
Received: from [127.0.0.1] (helo=sfs-ml-3.v29.lw.sourceforge.com)
	by sfs-ml-3.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1vaGfV-0003hj-Qc
	for lists+osst-users@lfdr.de;
	Mon, 29 Dec 2025 17:04:29 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-3.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <bounce.L3206S33016M1055@s1.arrobamail.com>)
 id 1vaGfV-0003hd-A3 for osst-users@lists.sourceforge.net;
 Mon, 29 Dec 2025 17:04:29 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=nTT1u2tUi689o8iAHf2VLRrWiXdck/onbs/EB+fepbU=; b=XVSwknvbdUnK7XNLKe/AOf/16O
 pnMLpmTyQAyebvaWf8O4i0VCR35frxn+at//iEv6e4LgWxv1XJgZ4HLxRbzTtMcba4YBTEmfFJsYl
 h8eUv2Bz5+T3VmmkayCvHIotLCSVY9B+1q1QnnFU3MJgYwHkTc3iJlOzbBJWbNM3OECE=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=nTT1u2tUi689o8iAHf2VLRrWiXdck/onbs/EB+fepbU=; b=D
 fPYyFHMc+tqpA1Z7+WzZP4B2jxMbobXBVnmTCoUB6Is4Syz7UkG/onQ04HAr75HWBzkJwlwNtTwo8
 uyiceTQpMaW3jSW0+KUhBBwcCE6qH9V5j1JqooQSqvC7ZAxtljDK6oGJhxmELiiKahiTqKBf2wwkl
 Gzc9OYwcZTaYqrF8=;
Received: from p145i146.fmpear.com.ar ([190.105.145.146] helo=mailer)
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1vaGfU-0007WW-5k for osst-users@lists.sourceforge.net;
 Mon, 29 Dec 2025 17:04:29 +0000
Date: Mon, 29 Dec 2025 11:04:16 -0600
To: Osst-users <osst-users@lists.sourceforge.net>
From: =?utf-8?Q?Valeria_P=C3=A9rez?= <valeria.perez@vorecol-mail.com>
Message-ID: <430633e2d619ddb33a8554011a3b2b5b@s1.arrobamail.com>
X-Mailer: FMMailer v3
X-Data: ZXxvc3N0LXVzZXJzQGxpc3RzLnNvdXJjZWZvcmdlLm5ldHw=
X-Fid: eGZpZC1vc3N0LXVzZXJzQGxpc3RzLnNvdXJjZWZvcmdlLm5ldC0xMDU1LTMyMDYtMzMwMTYtMjcxLXMxLmFycm9iYW1haWwuY29t
X-fmbh: b3NzdC11c2Vyc0BsaXN0cy5zb3VyY2Vmb3JnZS5uZXQ7MTA1NTszMjA2OzMzMDE2OzI3MQ==
X-bhid: X-bhd: 1055;3206;33016
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-AntiAbuse: abuse@outservices.net
Precedence: bulk
Feedback-ID: 1055:3206s33016:124933:WPservicesESP
X-Transport: p145i146tecsid
MIME-Version: 1.0
DKIM-Signature: v=1; d=vorecol-mail.com; s=fm;
 a=rsa-sha256; q=dns/txt; t=1767027856; c=relaxed/simple;
 h=Date:To:From:Reply-To:Subject:Message-ID:X-Mailer:X-Data:X-Fid:X-fmbh:List-Unsubscribe:X-AntiAbuse:Feedback-ID:List-ID:MIME-Version:Content-Type;
 z=Date:Mon,=2029=20Dec=202025=2011:04:16=20-0600
 ...
 |X-Fid:eGZpZC1vc3N0LXVzZXJzQGxpc3RzLnNvdXJjZWZvcmdlLm5ldC0xMDU1LTMyMDYtMzM
 wMTYtMjcxLXMxLmFycm9iYW1haWwuY29t
 |X-fmbh:b3NzdC11c2Vyc0BsaXN0cy5zb3VyY2Vmb3JnZS5uZXQ7MTA1NTszMjA2OzMzMDE2Oz
 I3MQ=3D=3D
 |List-Unsubscribe:<https://s1.arrobamail.com/unsuscribe.php?FormData=3Drrq
 wusrequswqyyseiw> |X-AntiAbuse:abuse@outservices.net
 |Feedback-ID:1055:3206s33016:124933:WPservicesESP
 |List-ID:<38472:594288> |MIME-Version:1.0
 |Content-Type:multipart/alternative=3B=20boundary=3D"b1_1hf9pN2dU0OhtYI9Mf
 gQcw1I8gpucenOFsyYURDslo";
 bh=prYaG7vC0y8J6sfv+1VHsOMhf79tYY7MQ2GO1sO6DXM=;
 b=MvmZgBIS/eEhUmIHqdHP4YqniCavmuZtGVPkYZY2AmJEQMGEbFv35HmQQ6ViiRyPvXYWjCdTz
 n48COZDomlwBdG9STNrdaHwlZtwvpXXtc/q0wi6mW9QxrWKpxR6kzy8AnB5WN/CrWGkZ9/wYB
 gRVyvdd41LhE1uzsEbew8qFgE=
...
X-Spam-Report: Spam detection software, running on the system "sfi-spamd-2.hosts.colo.sdot.me",
 ...
 -1.0 MAILING_LIST_MULTI     Multiple indicators imply a widely-seen list
                             manager
X-Headers-End: 1vaGfU-0007WW-5k
...
Content-Type: multipart/mixed; boundary="===============0535214439832096599=="
...
Content-Type: multipart/alternative;
 boundary="b1_1hf9pN2dU0OhtYI9MfgQcw1I8gpucenOFsyYURDslo"

This is a multi-part message in MIME format.

--b1_1hf9pN2dU0OhtYI9MfgQcw1I8gpucenOFsyYURDslo
...
=3D"https://s1.arrobamail.com/unsuscribe.php?id=3Drrqwusrequswqyyseiw">haz =
...
d=3D1066045467AZD&lid=3D1028156957AZD&mid=3D1025423036AZD&uid=3D1024426572A=
ZD&addr=3DA2gBdFFzWCFSeAYiBXJRYQEhUnsAEFptVDpTcAAgVnFVfw96BDoMdFQhU2FXNgIxA=
D1QeFJlDjBReAA.Dz5RcQ%3D%3D&xfid=3Drrqwusrequswqyyseiw" style=3D"border:non=

...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 661AF7487D0
	for <lists+osst-users@lfdr.de>; Wed,  5 Jul 2023 17:23:27 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1qH4Ll-0007q9-PF
	for lists+osst-users@lfdr.de;
	Wed, 05 Jul 2023 15:23:26 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <luis.rodriguez@consultores-rh.com>)
 id 1qH4Lj-0007q3-Pg for osst-users@lists.sourceforge.net;
 Wed, 05 Jul 2023 15:23:24 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=SsxWqrPcdSF+lpoMGVS/WmY1bKiTQE9qGfwb5m4fV0E=; b=ToQU/Qr1Q5yARAdbvzpJtVT7AH
 jQSDJJwiOijw8xP8aOOk5kf1x66vlO3gVfRIXDgDemczaOXaeC7mRkLNw+ONS/y/wOjpkR6L6X9+w
 TpwVzbkYPcqAOX21M6UuXzX7iLxnRcrPmpDbmC7wKLGGrkctsxvz/+UXskpkRh+aTeu4=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=SsxWqrPcdSF+lpoMGVS/WmY1bKiTQE9qGfwb5m4fV0E=; b=HL4GMU7JCVq7
 xSHOdGMNYmMKY6/Xig3alE2od1T7kBxn1Evn8/R9A7lpvvCGyaV8ijaTtZPUBwRNIeXRyenwVEbbT
 oDvHKbXx66COMz8brPrBW73dreb1qgCrrAJ/Cs5dwCyqtihZRXCAv0rbEL2DOPaCEVKIx3nMtI5nN
 pmsqg=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1qH4Lh-007Ldy-1u for osst-users@lists.sourceforge.net;
 Wed, 05 Jul 2023 15:23:24 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=SsxWqrPcdSF+lpoMGVS/WmY1bKiTQE9qGfwb5m4fV0E=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=SsxWqrPcdSF+lpoMGVS/WmY1bKiTQE9qGfwb5m4fV0E=;
 b=
From: =?UTF-8?B?THVpcyByb2Ryw61ndWV6?= <luis.rodriguez@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_770yQXkFgzYB@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_770yQXkFgzYB
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=omm85y4e&token=qurlus0x
Feedback-ID: 287535:287535-4559:campaign:IPRPL
Date: Wed, 5 Jul 2023 15:23:21 +0000
X-Spam-Score: 5.3 (+++++)
...
X-Headers-End: 1qH4Lh-007Ldy-1u
...
Content-Type: multipart/mixed; boundary="===============0320129703230791143=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============0320129703230791143==
Content-Type: multipart/related;
 boundary="--==_mimepart_64a58ae651ff3_13fb1db18d2e820291d2";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64a58ae651ff3_13fb1db18d2e820291d2
Content-Type: multipart/alternative;
 boundary="--==_mimepart_64a58ae651e8b_13fb1db18d2e8202908d";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64a58ae651e8b_13fb1db18d2e8202908d
...
/* List Definitions */
@list l0
	{mso-list-id:156582680;
	mso-list-template-ids:1541859146;}
@list l1
...
<img src=3D"https://tr220505813.consultores-rh.com/i/omm85y4e/qurlus0x.gi=

...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id C55D989EDBD
	for <lists+osst-users@lfdr.de>; Wed, 10 Apr 2024 10:37:30 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1ruTST-0002Ur-9a
	for lists+osst-users@lfdr.de;
	Wed, 10 Apr 2024 08:37:29 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <bounce.L3079S11945M80@s1.arrobamail.com>)
 id 1ruTSP-0002To-IN for osst-users@lists.sourceforge.net;
 Wed, 10 Apr 2024 08:37:26 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=gowWGyY0hHhkmVVdTzf/vMNAIEwJmPRbfUMjIhzrOno=; b=BlPPfJ+amymmNVhXDLZW4Y5khV
 tzknnpokiPy1tYH1G8MOXRGJ5MXsdrOESmaBMUilpKgl7OoxbYihfDICMpF3mkSCF6XUpHwwYZpuR
 VYfMsMdZM/WRhK4r0yDqnUenYERBZKFrv5JhVRIEV3M1kbrZcIORAIfC7DtmG0Oj8rJI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=gowWGyY0hHhkmVVdTzf/vMNAIEwJmPRbfUMjIhzrOno=; b=g
 L3gYtL+tVaRYM5bbuoLpz0aWpKYiL/KhJVqriOm0R+rW6qM500gnxiQB/lslNGz/ae5QDKxA7Yl7W
 gk/vZ4USovdAYw89WKG6ayp71NHyUl+A2T2UZbgTz4Na10pIcKhmvwBQRVHZxso4QHEDPIcyjEhW+
 E22CmL+TDwv5XZSA=;
Received: from pf-28.fleetservers.net ([190.105.146.28])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1ruTSN-00044W-Ol for osst-users@lists.sourceforge.net;
 Wed, 10 Apr 2024 08:37:25 +0000
Date: Wed, 10 Apr 2024 03:35:56 -0500
To: osst-users@lists.sourceforge.net
From: =?utf-8?Q?Daniel_Rodr=C3=ADguez?= <daniel.rodriguez@consultores-rh.com>
Message-ID: <SSyMdlLZ8Y9JHQV1mXlcsRqDKAdLl7kXD765uu4lrtE@s1.arrobamail.com>
X-Mailer: FMMailer v3
X-Data: ZXxvc3N0LXVzZXJzQGxpc3RzLnNvdXJjZWZvcmdlLm5ldHw=
X-Fid: eGZpZC1vc3N0LXVzZXJzQGxpc3RzLnNvdXJjZWZvcmdlLm5ldC04MC0zMDc5LTExOTQ1LTI2OS1zMS5hcnJvYmFtYWlsLmNvbQ==
X-fmbh: b3NzdC11c2Vyc0BsaXN0cy5zb3VyY2Vmb3JnZS5uZXQ7ODA7MzA3OTsxMTk0NTsyNjk=
X-bhid: X-bhd: 80;3079;11945
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-AntiAbuse: abuse@outservices.net
Precedence: bulk
Feedback-ID: 80:3079s11945:124931:WPservicesESP
X-Transport: AgdLcOmFm
MIME-Version: 1.0
DKIM-Signature: v=1; d=consultores-rh.com; s=fm;
 a=rsa-sha256; q=dns/txt; t=1712738156; c=relaxed/simple;
 h=Date:To:From:Reply-To:Subject:Message-ID:X-Mailer:X-Data:X-Fid:X-fmbh:List-Unsubscribe:X-AntiAbuse:Feedback-ID:List-ID:MIME-Version:Content-Type;
 z=Date:Wed,=2010=20Apr=202024=2003:35:56=20-0500
 |To:osst-users@lists.sourceforge.net
 ...
 |X-Fid:eGZpZC1vc3N0LXVzZXJzQGxpc3RzLnNvdXJjZWZvcmdlLm5ldC04MC0zMDc5LTExOTQ
 1LTI2OS1zMS5hcnJvYmFtYWlsLmNvbQ=3D=3D
 |X-fmbh:b3NzdC11c2Vyc0BsaXN0cy5zb3VyY2Vmb3JnZS5uZXQ7ODA7MzA3OTsxMTk0NTsyNj
 k=3D
 |List-Unsubscribe:<https://s1.arrobamail.com/unsuscribe.php?FormData=3Dwwp
 tysrqipsoqseup> |X-AntiAbuse:abuse@outservices.net
 |Feedback-ID:80:3079s11945:124931:WPservicesESP
 |List-ID:<36948:215010> |MIME-Version:1.0
 |Content-Type:multipart/alternative=3B=20boundary=3D"b1_SSyMdlLZ8Y9JHQV1mX
 lcsRqDKAdLl7kXD765uu4lrtE";
 bh=gowWGyY0hHhkmVVdTzf/vMNAIEwJmPRbfUMjIhzrOno=;
 b=O89k4/7YzaegqyLWQzCmWEzZhBaya9v0u22Dit0hurtRwT/z86fbIXiBycDA8Fgn32Qr0ifyl
 m+l6umYq2Xu3CwIrIrazNynwiR6y/fP1bjU+2RW22+TvpuaiKgnXeYFTrpV64UyEpXrD4/dES
 AF068jYXU7cW3AwS9VSS8nDZY=
X-Spam-Score: -5.8 (-----)
X-Spam-Report: Spam detection software, running on the system "util-spamd-2.v13.lw.sourceforge.com",
 ...
 -1.0 MAILING_LIST_MULTI     Multiple indicators imply a widely-seen list
                             manager
X-Headers-End: 1ruTSN-00044W-Ol
...
Content-Type: multipart/mixed; boundary="===============5346532970285923767=="
...
Content-Type: multipart/alternative;
 boundary="b1_SSyMdlLZ8Y9JHQV1mXlcsRqDKAdLl7kXD765uu4lrtE"

This is a multi-part message in MIME format.

--b1_SSyMdlLZ8Y9JHQV1mXlcsRqDKAdLl7kXD765uu4lrtE
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable

=0A=0A=0A=09=0A=09=0A=0A=0AHola.=0A=0A&nbsp;=0A=0ASab=C3=ADa usted que, de =
acuerdo con la revista The Quarterly Journal of Economics en la actualidad =
se invierten 23 d=C3=ADas en contratar a un candidato y seg=C3=BAn&nbsp;la =
encuesta de Bryant &amp; Stratton College Online y Wakefield Research del 1=
00% de las contrataciones solo el 40% cumple con las necesidades de las vac=
antes.=0A=0A&nbsp;=0A=0AEsto quiere decir que, adem=C3=A1s&nbsp;de ser lent=
o el proceso de selecci=C3=B3n&nbsp;de personal, la mayor=C3=ADa de los can=
didatos no cubren al 100% las necesidades laborales=0A=0A&nbsp;=0A=0A=C2=
=BFInvierte mucho tiempo en cubrir sus vacantes?=0A=0A=C2=BFSus candidatos =
no siempre son los mejores?=0A=0A&nbsp;=0A=0AMuchas empresas y organizacion=
es utilizan a PsicoSmart como herramienta de reclutamiento y selecci=C3=
=B3n, ya que les ayuda a conocer a detalle las competencias de sus candidat=
os, as=C3=AD como agilizar el proceso de reclutamiento y selecci=C3=B3n&nbs=
p;por medio de people analytics, inteligencia artificial, validaci=C3=B3n&n=
bsp;de identidad, entre otros m=C3=A9todos que le dar=C3=A1n&nbsp;claridad =
y certeza al momento de la toma de decisiones=0A=0A&nbsp;=0A=0ASi le intere=
sa mejorar su proceso de reclutamiento, responda&nbsp;este email dando clic=
 aqu=C3=AD o puede&nbsp;contactar conmigo en los siguientes n=C3=BAmeros te=
lef=C3=B3nicos.=0A=0A&nbsp;=0A=0A=0A=09=0A=09=09=0A=09=09=09=0A=09=09=09Dan=
iel Rodr=C3=ADguez=0A=0A=09=09=09Ll=C3=A1manos&nbsp;sin costo: 00 1 (880) 3=
51 7924=0A=0A=09=09=09Ciudad de M=C3=A9xico: (55) 5018 0565=0A=0A=09=09=09C=
olombia, Bogot=C3=A1: (571) 580 0351=0A=0A=09=09=09Rep=C3=BAblica Dominican=
a: (829) 954 8077=0A=0A=09=09=09Guatemala: (502) 2315 9835=0A=0A=09=09=09El=
 Salvador: (503) 2113 9422=0A=0A=09=09=09Chile: (56) 2258 35929=0A=0A=09=09=
=09WhatsApp: +52 33 1607 2089=0A=0A=09=09=09&nbsp;=0A=09=09=09=0A=09=09=09=
...
=3Dwwptysrqipsoqseup">click aqu&iacute;</a>
--b1_SSyMdlLZ8Y9JHQV1mXlcsRqDKAdLl7kXD765uu4lrtE
Content-Type: multipart/related;
 boundary="b2_SSyMdlLZ8Y9JHQV1mXlcsRqDKAdLl7kXD765uu4lrtE";
 type="text/html"

--b2_SSyMdlLZ8Y9JHQV1mXlcsRqDKAdLl7kXD765uu4lrtE
...
<body data-gramm=3D"false" data-lt-tmp-id=3D"lt-794972" style=3D"cursor: au=
to;">
<p style=3D"background: white; margin: 0cm;"><font face=3D"Calibri">Hola.</=
font></p>
...
=ADa usted que, de acuerdo con la revista The Quarterly Journal of Economic=
s <strong>en la actualidad se invierten 23 d=C3=ADas en contratar a un cand=
idato</strong> y seg=C3=BAn&nbsp;la encuesta de Bryant &amp; Stratton Colle=
ge Online y Wakefield Research <strong>del 100% de las contrataciones solo =
el 40% cumple con las necesidades de las vacantes.</strong></font></span></=
span></p>
...
ailOriginal"><span style=3D"color:black"><font face=3D"Calibri">Esto quiere=
 decir que, adem=C3=A1s&nbsp;de ser lento el proceso de selecci=C3=B3n&nbsp=
;de personal, la mayor=C3=ADa de los candidatos no cubren al 100% las neces=
idades laborales</font></span></span></p>
...
de sus candidatos, as=C3=AD como agilizar el proceso de reclutamiento y<str=
ong> selecci=C3=B3n&nbsp;por medio de people analytics, inteligencia artifi=
cial, validaci=C3=B3n&nbsp;de identidad</strong>, entre otros m=C3=A9todos =
que le dar=C3=A1n&nbsp;claridad y certeza al momento de la toma de decision=
es</font></span></span></p>
...
le interesa mejorar su proceso de reclutamiento, responda&nbsp;este email d=
ando</font></span></strong></span> <a href=3D"mailto:contacto@psicosmart.pr=
o?subject=3DInformaci%C3%B3n%20sobre%20PsicoSmart&amp;body=3DMis%20datos%20=
son%20%0ANombre%3A%20%0AEmpresa%3A%20%0ATel%C3%A9fono%3A%20%0AComentarios%3=
A%20%0A%C2%A1Gracias!%20%0A"><span style=3D"mso-bookmark:_MailOriginal"><st=
rong><span lang=3D"ES-TRAD" style=3D"mso-ansi-language:ES-TRAD"><font face=
=3D"Calibri">clic aqu=C3=AD</font></span></strong></span></a> <span style=
=3D"mso-bookmark:_MailOriginal"><strong><span style=3D"color:black"><font f=
ace=3D"Calibri">o puede&nbsp;contactar conmigo en los siguientes n=C3=BAmer=
os telef=C3=B3nicos.</font></span></strong></span></p>
...
4673AZD&id=3Dwwptysrqipsoqseup&url=3DaHR0cHM6Ly9hcGkud2hhdHNhcHAuY29tL3Nlbm=
...
hp?id=3Dwwptysrqipsoqseup">click aqu&iacute;</a></div><div align=3D"center"=
...
ysrqipsoqseup">aqu&iacute;</a></div>
<img src=3D"https://s1.arrobamail.com/class/open_track.php?dataType=3Dt3&si=
d=3D1039264226AZD&lid=3D1027995540AZD&mid=3D1024183811AZD&uid=3D1024424030A=
ZD&addr=3DBG9QJQclCnMELlRwUyQHNwAgWnNTQ1luAmwBIlV1VHMGLFQhAjwLc1EkADJQMVFiU=
WwCKgE2AT9TegM9Dj9Scg&xfid=3Dwwptysrqipsoqseup" style=3D"border:none !impor=

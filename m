...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 55D3374A27F
	for <lists+osst-users@lfdr.de>; Thu,  6 Jul 2023 18:51:21 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1qHSCN-00007X-Ak
	for lists+osst-users@lfdr.de;
	Thu, 06 Jul 2023 16:51:20 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <jassiel.ramirez@consultores-rh.com>)
 id 1qHSCL-00007R-NC for osst-users@lists.sourceforge.net;
 Thu, 06 Jul 2023 16:51:18 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=iFEeeqmlIW1GGSqdNQyn5590LXjUgLGSnDttJhTJxMA=; b=HqZ6oqGhbgl4ycMfPMhouWt2Mz
 dwfnTKVXPTW46DyrJqtGTYSvwgCq5Bvza435QP9aWTL5st3HKxjWEZttgC/nI3VLKziWiqFILBolq
 wqxyjB0sXT4reWMXkttSvcJ5kXvPS1gLv5FNUtJpnIIgIfx47j6lB5aSa300N0rQbKz4=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=iFEeeqmlIW1GGSqdNQyn5590LXjUgLGSnDttJhTJxMA=; b=izrrlHn+VWTB
 Tf6NRbBKwlehZjtNRPg1UljAdTAXF7wZzsRgoFC62UkFKerNNJn/vPrMzWM7UHbxOLWH8MGwWorgs
 pmc6VwgEsmQwUbCN6aBSRa4JW/e/yVMGZjjkTG9Lh/wAgrKunqJ+mfzlN40zxtza8RR9GiP8k+Yip
 CoE3I=;
Received: from bednarwitting.r.mx-router-i.com ([212.192.13.57])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1qHSCK-0001e2-VE for osst-users@lists.sourceforge.net;
 Thu, 06 Jul 2023 16:51:18 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=iFEeeqmlIW1GGSqdNQyn5590LXjUgLGSnDttJhTJxMA=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=iFEeeqmlIW1GGSqdNQyn5590LXjUgLGSnDttJhTJxMA=;
 b=
From: =?UTF-8?B?SmFzc2llbCBSYW3DrXJleg==?= <jassiel.ramirez@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_Jz4BrD6S3YdB@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_Jz4BrD6S3YdB
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=ommjojq9&token=v6ggwcvl
Feedback-ID: 287535:287535-4562:campaign:IPRPL
Date: Thu, 6 Jul 2023 16:51:17 +0000
X-Spam-Score: 4.7 (++++)
...
X-Headers-End: 1qHSCK-0001e2-VE
...
Content-Type: multipart/mixed; boundary="===============8770324652031036858=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============8770324652031036858==
Content-Type: multipart/related;
 boundary="--==_mimepart_64a6f0fc86d67_13fb69f559994123129b0";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64a6f0fc86d67_13fb69f559994123129b0
Content-Type: multipart/alternative;
 boundary="--==_mimepart_64a6f0fc86b73_13fb69f55999412312886";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64a6f0fc86b73_13fb69f55999412312886
...
=E2=80=A2 Equidad Salarial: Crear=C3=A1s tabuladores de sueldos justos y
...
=E2=80=A2 Ahorro de Tiempo: Reducir=C3=A1s el tiempo dedicado a la elabor=
aci=C3=B3n
de c=C3=A1lculos salariales, permiti=C3=A9ndote enfocarte en otras =C3=A1=
reas
cr=C3=ADticas de tu d=C3=ADa a d=C3=ADa.

=E2=80=A2 Precisi=C3=B3n y Eficiencia: Minimizar=C3=A1s los errores en lo=
s c=C3=A1lculos
...
( https://tr220505813.consultores-rh.com/c/ommjojq9/v6ggwcvl/djikgqsnat0 =
)
...
<p class=3D"MsoNormal"><span lang=3D"ES" style=3D"mso-fareast-language:ES=
-MX">Hola,<b> </b></span><span lang=3D"ES" style=3D"color:black">buen d=C3=
=ADa Lic.</span></p>
<p></p>
...
></p></span></p>
<p class=3D"MsoNormal"><span lang=3D"ES-TRAD"><p>=C2=A0</p></span></p>
<p class=3D"MsoNormal"><span lang=3D"ES-TRAD">=E2=80=A2 <b>Equidad Salari=
al:</b> Crear=C3=A1s tabuladores de sueldos justos y equitativos para tus=
 empleados, lo que aumentar=C3=A1 la satisfacci=C3=B3n, motivaci=C3=B3n y=
 retenci=C3=B3n de talento en tu empresa.<p></p></span></p>
<p class=3D"MsoNormal"><span lang=3D"ES-TRAD">=E2=80=A2 <b>Ahorro de Tiem=
po</b>: Reducir=C3=A1s el tiempo dedicado a la elaboraci=C3=B3n de c=C3=A1=
lculos salariales, permiti=C3=A9ndote enfocarte en otras =C3=A1reas cr=C3=
=ADticas de tu d=C3=ADa a d=C3=ADa.<p></p></span></p>
<p class=3D"MsoNormal"><span lang=3D"ES-TRAD">=E2=80=A2 <b>Precisi=C3=B3n=
 y Eficiencia:</b> Minimizar=C3=A1s los errores en los c=C3=A1lculos sala=
riales, evitando posibles conflictos laborales y ahorrando costos de corr=
ecci=C3=B3n.<p></p></span></p>
<p class=3D"MsoNormal"><span lang=3D"ES-TRAD"><p>=C2=A0</p></span></p>
...
.com/c/ommjojq9/v6ggwcvl/djikgqsnat0"><span lang=3D"ES-TRAD" style=3D"mso=
...
5in;height:1.25in" id=3D"Imagen_x0020_1" src=3D"cid:image001.png@01D98811=
.62DEA400"></span><span style=3D"mso-fareast-language:ES-MX"><p></p></spa=
n></p></td>
</tr></table>
...
<img src=3D"https://tr220505813.consultores-rh.com/i/ommjojq9/v6ggwcvl.gi=

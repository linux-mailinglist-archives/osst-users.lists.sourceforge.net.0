...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 81A4C934986
	for <lists+osst-users@lfdr.de>; Thu, 18 Jul 2024 10:06:43 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1sUM9w-0004LH-PI
	for lists+osst-users@lfdr.de;
	Thu, 18 Jul 2024 08:06:40 +0000
Received: from [172.30.29.67] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <jan.polasek@envisioncraftsman.com>)
 id 1sUM9v-0004LB-4y for osst-users@lists.sourceforge.net;
 Thu, 18 Jul 2024 08:06:39 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=uGTmdNfeKWYppKfROrYtp0X+RK7/pRJQsBUrarqToyk=; b=SevrwiNpL3wIiS6XNjjET7MN8V
 39KB3xNC0jFyv74hPRYr6+2JhuDfuVXMeWx3izkP3wyWRURbWgGLiy/LW+Nc94O3QzSUAHReD4hf5
 qDU20PPw3VnTLTST6Q0a73uq+K09/AJYaHMah6p36WkF2NDTL3NWh1K4pjzdD9aWrXQ0=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 at/3auLg6yaoNo7YS1MHEhzgUgNNmBr0a4IQKeDFjdwQLZqKOeOuGL0BgSljdljzOVKRLIGlnYMcu
 qnVeJ0DsBXpg2o2EmlwMfQ2WshgjUzcki2G1v4B4zpkdPGTQ8uuz2dzR13ChnELmBfAEtNHuAtDtP
 M2MPo+uhQ0LUqg4o=;
Received: from mail.envisioncraftsman.com ([162.19.67.48])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1sUM9u-0005Jj-MK for osst-users@lists.sourceforge.net;
 Thu, 18 Jul 2024 08:06:39 +0000
Received: by mail.envisioncraftsman.com (Postfix, from userid 1002)
 id 26E0123A07; Thu, 18 Jul 2024 10:06:01 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=envisioncraftsman.com; s=mail; t=1721289970;
 bh=uGTmdNfeKWYppKfROrYtp0X+RK7/pRJQsBUrarqToyk=;
 h=Date:From:To:Subject:From;
 b=
Received: by mail.envisioncraftsman.com for <osst-users@lists.sourceforge.net>;
 Thu, 18 Jul 2024 08:05:41 GMT
Message-ID: <20240718084500-0.1.3w.oka4.0.11b074l9x7@envisioncraftsman.com>
Date: Thu, 18 Jul 2024 08:05:41 GMT
...
X-Headers-End: 1sUM9u-0005Jj-MK

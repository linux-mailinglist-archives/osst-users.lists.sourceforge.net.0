...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 408206C3827
	for <lists+osst-users@lfdr.de>; Tue, 21 Mar 2023 18:26:03 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1pefkH-0007I6-HQ
	for lists+osst-users@lfdr.de;
	Tue, 21 Mar 2023 17:26:02 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <valeria.perez@consultores-rh.com>)
 id 1pefkG-0007Hm-K6 for osst-users@lists.sourceforge.net;
 Tue, 21 Mar 2023 17:26:01 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=ZAe0E+I0zBGsJX8VskWwcYQEO+Lm1tSUnSCDH6LR9+I=; b=Sdbk2eBSWBY1sniw9bi3BKo9I+
 QD2eKgjjeMz+GqWoyY4Ccy6+phtn5l3lNNBFdzpIxmXVXPo9dbY1hz6XqXkvGwyENZJXN0jDB3W+T
 WgUWOP4A3BtdtD5HOd4nq2nZihTtj1WJ5dtFekPiuQ3m+IVftfa22Y8JIgYG+ox+SQSI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=ZAe0E+I0zBGsJX8VskWwcYQEO+Lm1tSUnSCDH6LR9+I=; b=UaXmIdibMq3o
 garkqa/SOzojDAJS00PGg4niv7vJfVq43ZvTL+89wFT4+P+KEHO5eOZzRVymBTr9bY8j24inB4uvP
 NVocJYwTjW7/jw9X2jAJN9HEg+K1NM3lKhWvB3X5LfCwk0R0BR08QiuYj74pG2q5i0nrkXxTtCDyZ
 z+W28=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pefkF-0002Nh-MX for osst-users@lists.sourceforge.net;
 Tue, 21 Mar 2023 17:26:01 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=ZAe0E+I0zBGsJX8VskWwcYQEO+Lm1tSUnSCDH6LR9+I=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=ZAe0E+I0zBGsJX8VskWwcYQEO+Lm1tSUnSCDH6LR9+I=;
 b=
From: =?UTF-8?B?VmFsZXJpYSBQw6lyZXo=?= <valeria.perez@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_jr2Yo8gc0LW7@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_jr2Yo8gc0LW7
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=6gxd8me4&token=vlrqv4ka
Feedback-ID: 287535:287535-4377:campaign:IPRPL
Date: Tue, 21 Mar 2023 17:25:59 +0000
X-Spam-Score: 6.6 (++++++)
X-Spam-Report: Spam detection software, running on the system "util-spamd-2.v13.lw.sourceforge.com",
 ...
 Content preview:  Hola. Espero que estés bien. Te escribo para hablarte sobre
    una herramienta de evaluación de desempeño en línea que puede ser de gran
    ayuda para tu empresa: Smart360. Como sabes, en mi empresa hemos utilizado
    Smart360 con excelentes resultados. Nos ha permitido recopilar información
    valiosa sobre el rendimiento laboral de nuestros empleados y mejorar el diálogo
    y [...] 
...
X-Headers-End: 1pefkF-0002Nh-MX
...
Content-Type: multipart/mixed; boundary="===============8049334216839879681=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============8049334216839879681==
Content-Type: multipart/related;
 boundary="--==_mimepart_6419e89fd0150_13fb34e67615024001e1";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_6419e89fd0150_13fb34e67615024001e1
Content-Type: multipart/alternative;
 boundary="--==_mimepart_6419e89fd0030_13fb34e676150240005b";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_6419e89fd0030_13fb34e676150240005b
...
Espero que est=C3=A9s bien. Te escribo para hablarte sobre una
herramienta de evaluaci=C3=B3n de desempe=C3=B1o en l=C3=ADnea que puede =
ser de
gran ayuda para tu empresa: Smart360.

Como sabes, en mi empresa hemos utilizado Smart360 con excelentes
resultados. Nos ha permitido recopilar informaci=C3=B3n valiosa sobre
el rendimiento laboral de nuestros empleados y mejorar el di=C3=A1logo
y la colaboraci=C3=B3n dentro del equipo. Es por eso por lo que pens=C3=A9=

que ser=C3=ADa genial recomend=C3=A1rtela.

Smart360 es una plataforma f=C3=A1cil de usar y personalizable que te
permite adaptar la evaluaci=C3=B3n de desempe=C3=B1o a las necesidades
espec=C3=ADficas de tu empresa y equipo. Puedes recopilar informaci=C3=B3=
n
de diferentes fuentes, incluyendo supervisores, compa=C3=B1eros de
trabajo y subordinados, y recibir retroalimentaci=C3=B3n constructiva
para identificar fortalezas y debilidades.

Tambi=C3=A9n te brinda la oportunidad de planificar el desarrollo
profesional de tus empleados y mejorar la comunicaci=C3=B3n entre t=C3=BA=
 y
tu equipo. Adem=C3=A1s, Smart360 es una herramienta eficiente que
ahorra tiempo y esfuerzo al automatizar el proceso de evaluaci=C3=B3n.

Si te interesa implementar esta evaluaci=C3=B3n en tu empresa,
responde este email dando clic aqu=C3=AD (
...
=C2=A1Te aseguro que implementar Smart360 ser=C3=A1 una gran inversi=C3=B3=
n para
tu empresa y tu equipo! Espero tu respuesta.
...
<p></p>
<p class=3D"MsoNormal">Espero que est=C3=A9s bien. <b><span style=3D"colo=
r:#548235">Te escribo para hablarte sobre una herramienta de evaluaci=C3=B3=
n de desempe=C3=B1o en l=C3=ADnea que puede ser de gran ayuda para tu emp=
resa</span></b>: <b>Smart360</b>.</p>
<p></p>
<p class=3D"MsoNormal">Como sabes, en mi empresa hemos utilizado Smart360=
 con excelentes resultados. Nos ha permitido recopilar informaci=C3=B3n v=
aliosa sobre el rendimiento laboral de nuestros empleados y mejorar el di=
=C3=A1logo y la colaboraci=C3=B3n dentro del equipo. Es por eso por lo qu=
e pens=C3=A9 que ser=C3=ADa genial recomend=C3=A1rtela.</p>
<p></p>
<p class=3D"MsoNormal"></p>
<p>=C2=A0</p>
<p class=3D"MsoNormal"><b>Smart360 es una plataforma f=C3=A1cil de usar y=
 personalizable que te permite adaptar la evaluaci=C3=B3n de desempe=C3=B1=
o a las necesidades espec=C3=ADficas de tu empresa y equipo.</b> Puedes r=
ecopilar informaci=C3=B3n de diferentes fuentes, incluyendo supervisores,=
 compa=C3=B1eros de trabajo y subordinados, y recibir retroalimentaci=C3=B3=
n constructiva para identificar fortalezas y debilidades.</p>
<p></p>
<p class=3D"MsoNormal"><b>Tambi=C3=A9n te brinda la oportunidad de planif=
icar el desarrollo profesional de tus empleados y mejorar la comunicaci=C3=
=B3n entre t=C3=BA y tu equipo.</b> Adem=C3=A1s, Smart360 es una herramie=
nta eficiente que ahorra tiempo y esfuerzo al automatizar el proceso de e=
valuaci=C3=B3n.</p>
<p></p>
<p class=3D"MsoNormal"></p>
<p>=C2=A0</p>
<p class=3D"MsoNormal" style=3D"background:white"><span style=3D"color:bl=
ack">Si te interesa implementar esta evaluaci=C3=B3n en tu empresa, respo=
nde este email dando <a href=3D"mailto:contacto@psicosmart.pro?subject=3D=
...
<p>=C2=A0</p>
<p class=3D"MsoNormal" style=3D"background:white"><span style=3D"color:bl=
ack">=C2=A1Te aseguro que implementar Smart360 ser=C3=A1 una gran inversi=
=C3=B3n para tu empresa y tu equipo! Espero tu respuesta.</span></p>
<p></p>
<p class=3D"MsoNormal" style=3D"background:white"><span style=3D"color:bl=
ack">Saludos.</span></p>
<p></p>
...
<img src=3D"https://tr220505813.consultores-rh.com/i/6gxd8me4/vlrqv4ka.gi=

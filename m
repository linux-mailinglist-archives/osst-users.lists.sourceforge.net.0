...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 2D5D46F5C0C
	for <lists+osst-users@lfdr.de>; Wed,  3 May 2023 18:31:41 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1puFOG-0003M4-1n
	for lists+osst-users@lfdr.de;
	Wed, 03 May 2023 16:31:40 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <mariann.rivas@consultores-rh.com>)
 id 1puFOE-0003Lx-Hd for osst-users@lists.sourceforge.net;
 Wed, 03 May 2023 16:31:38 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=HLnq3ZeLdiI6NVPwW7V4YmZarhiJSdKtBi/jN983NSc=; b=JH8b31d3g0BSEOUojp7cmrLzo9
 9BymDCcar6vGkK2fl2s4bTebShohTM/NESMCfst4+PT0MD76EAm1aBJoNtSjDI9PvKNK21DZy8Cw9
 kn5yPqaZXoq/jr4DAQeIXQ/HCJw+8ZMM9hzxlRQZRQTKngJmW2m9GXNhm5GbAoXZVrcY=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=HLnq3ZeLdiI6NVPwW7V4YmZarhiJSdKtBi/jN983NSc=; b=I5C+yMTlXQoy
 vQp1mx2fwdkTmgopDJ4BLbJZajJ4UcpOSZCkozWjJHFHKFtyDrlAPUk2syHGJ1X2s42Y4JbemW3Qz
 IcDKfaZArjKMJ5/jF6oqTbcr0giJdZhfDNowPYGDAgthb4xFSVS20UdDnKJ/PD0pE2akLhOHep4BN
 4rHfQ=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1puFOD-00D3hZ-1o for osst-users@lists.sourceforge.net;
 Wed, 03 May 2023 16:31:38 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=HLnq3ZeLdiI6NVPwW7V4YmZarhiJSdKtBi/jN983NSc=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=HLnq3ZeLdiI6NVPwW7V4YmZarhiJSdKtBi/jN983NSc=;
 b=
From: Mariann Rivas <mariann.rivas@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_Wv1kwmncowKR@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_Wv1kwmncowKR
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=xj1dxj7g&token=gnlpcweo
Feedback-ID: 287535:287535-4431:campaign:IPRPL
Date: Wed, 3 May 2023 16:31:37 +0000
X-Spam-Score: 5.3 (+++++)
...
X-Headers-End: 1puFOD-00D3hZ-1o
...
Content-Type: multipart/mixed; boundary="===============8338556934192490688=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============8338556934192490688==
Content-Type: multipart/related;
 boundary="--==_mimepart_64528c60e2503_13fee9559c7ac7052128";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64528c60e2503_13fee9559c7ac7052128
Content-Type: multipart/alternative;
 boundary="--==_mimepart_64528c60e2113_13fee9559c7ac70520fb";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64528c60e2113_13fee9559c7ac70520fb
...
( https://tr220505813.consultores-rh.com/c/xj1dxj7g/gnlpcweo/bhwb1codf54 =
)
...
pt 0cm 0cm 0cm"><p class=3D"MsoNormal"><span style=3D"color:black">Hola, =
</span><span lang=3D"ES" style=3D"mso-fareast-language:ES-MX"><p></p></sp=
an></p></div></div>
<p class=3D"MsoNormal" style=3D"background:white"></p>
<p>=C2=A0</p>
<p class=3D"MsoNormal" style=3D"background:white"><span style=3D"color:bl=
ack">En estos tiempos de alta competencia y demanda de talento</span><b><=
span style=3D"color:#C55A11">, el departamento de Recursos Humanos tiene =
un papel crucial en el =C3=A9xito de cualquier empresa.</span></b><span s=
tyle=3D"color:#C55A11"> </span><span style=3D"color:black">Por eso, enten=
demos que uno de tus principales desaf=C3=ADos es </span><b><span style=3D=
"color:#C55A11">encontrar y retener a los mejores candidatos para cada pu=
esto</span><span style=3D"color:black">.</span></b></p>
<p></p>
<p class=3D"MsoNormal" style=3D"background:white"><span style=3D"color:bl=
ack">Para ayudarte a superar este desaf=C3=ADo<b>, </b>te presentamos</sp=
an><b><span style=3D"color:#C55A11"> </span><span style=3D"color:black">P=
sicoSmart, una herramienta de aplicaci=C3=B3n de pruebas psicom=C3=A9tric=
as/psicot=C3=A9cnicas</span></b><span style=3D"color:black"> online que t=
e permitir=C3=A1 optimizar y simplificar tus procesos de selecci=C3=B3n.<=
/span></p>
<p></p>
<p class=3D"MsoNormal" style=3D"background:white"></p>
<p>=C2=A0</p>
...
><span style=3D"color:#C55A11">Te invitamos a probar PsicoSmart</span></b=
><span style=3D"color:#C55A11"> y </span><span style=3D"color:black">comp=
robar por ti mismo c=C3=B3mo puede ayudarte a mejorar tus procesos de sel=
ecci=C3=B3n. Para obtener m=C3=A1s informaci=C3=B3n sobre nuestro sistema=
 y c=C3=B3mo podemos ayudarte, da <a href=3D"mailto:contacto@psicosmart.p=
ro?subject=3DINFORMACI%C3%93N%20DEL%20TEMA%3a%20demostraci%C3%B3n%20Psico=
Smart&amp;body=3DMis%20datos%20son%0d%0a%0d%0aNombre%3a%0d%0aEmpresa%3a%0=
d%0aTel%C3%A9fono%3a%0d%0aComentarios%3a%0d%0a%0d%0a%C2%A1Gracias!"><span=
 lang=3D"ES-TRAD">clic aqu=C3=AD</span></a> o ll=C3=A1manos a los siguien=
tes n=C3=BAmeros</span></p>
<p></p>
<p class=3D"MsoNormal" style=3D"margin-bottom:12.0pt;background:white"><s=
pan style=3D"color:black">Saludos.</span></p>
<p></p>
...
.com/c/xj1dxj7g/gnlpcweo/bhwb1codf54"><span lang=3D"ES-TRAD" style=3D"mso=
...
<img src=3D"https://tr220505813.consultores-rh.com/i/xj1dxj7g/gnlpcweo.gi=

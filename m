...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id A0D8F6B9891
	for <lists+osst-users@lfdr.de>; Tue, 14 Mar 2023 16:09:40 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1pc6HS-0007fL-UB
	for lists+osst-users@lfdr.de;
	Tue, 14 Mar 2023 15:09:39 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <mariann.rivas@consultores-rh.com>)
 id 1pc6HR-0007f9-9x for osst-users@lists.sourceforge.net;
 Tue, 14 Mar 2023 15:09:37 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=q06OuVGcfFIRb4QQW2n6fL5F3+KrN3iKwks9k6tfHF0=; b=SnGbXvXPx4dHKPEVMbEg0sME2w
 iO31Yb7R8w+0Dgg6nxH1bLEs0shO3W3hjlLgJ+BmIuqY4aZnI4lic3ZmLPfJe0YX2/xb7zt6fHe6j
 IBJPBUOBHIhnyzu9HbWjAFQ7wkQBGUOt1YtWx4vun8PCyrO6EgsgFbjGeh3qykNMZRS0=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=q06OuVGcfFIRb4QQW2n6fL5F3+KrN3iKwks9k6tfHF0=; b=c0qv1b6umi1c
 CN17OHOKcAHmWpwpxEaslgHJO1VWBdFB5k8eCI29aJDZ+xl74biAVM5Qbn20bA4obhdREZ7q3RfP2
 QT/h3zFiHSx13OB7FF7/4FYOHH0HEcHtUaWmTgPnb4/kOOodGeocQGstObPHYVysL6lFogxHTEvkR
 XWp/M=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pc6HQ-008UMy-An for osst-users@lists.sourceforge.net;
 Tue, 14 Mar 2023 15:09:37 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=q06OuVGcfFIRb4QQW2n6fL5F3+KrN3iKwks9k6tfHF0=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=q06OuVGcfFIRb4QQW2n6fL5F3+KrN3iKwks9k6tfHF0=;
 b=
From: Mariann Rivas <mariann.rivas@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_D8o6kerTKv4P@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_D8o6kerTKv4P
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=gwk8dwye&token=zdejsjov
Feedback-ID: 287535:287535-4358:campaign:IPRPL
Date: Tue, 14 Mar 2023 15:09:36 +0000
X-Spam-Score: 5.3 (+++++)
...
X-Headers-End: 1pc6HQ-008UMy-An
...
Content-Type: multipart/mixed; boundary="===============3495715043553158957=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============3495715043553158957==
Content-Type: multipart/related;
 boundary="--==_mimepart_64108e2874407_13fd035a7c4f8914893";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64108e2874407_13fd035a7c4f8914893
Content-Type: multipart/alternative;
 boundary="--==_mimepart_64108e28741af_13fd035a7c4f8914726";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64108e28741af_13fd035a7c4f8914726
...
( https://tr220505813.consultores-rh.com/c/gwk8dwye/zdejsjov/bhwb1codf54 =
)
...
.com/c/gwk8dwye/zdejsjov/bhwb1codf54"><span lang=3D"ES-TRAD" style=3D"mso=
...
<img src=3D"https://tr220505813.consultores-rh.com/i/gwk8dwye/zdejsjov.gi=

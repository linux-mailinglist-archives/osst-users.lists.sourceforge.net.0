...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id BFE69759A21
	for <lists+osst-users@lfdr.de>; Wed, 19 Jul 2023 17:47:45 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1qM9Ox-0005JU-Qg
	for lists+osst-users@lfdr.de;
	Wed, 19 Jul 2023 15:47:44 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <luis.rodriguez@consultores-rh.com>)
 id 1qM9Ow-0005JN-3C for osst-users@lists.sourceforge.net;
 Wed, 19 Jul 2023 15:47:42 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=0HbpZ5y4KBTMmm6kgEOFcZ79PWJY5Yto/LStdXCr+8o=; b=Yaw6NQIBacidiM9YvueaCCrs7t
 zL4d5Qw7ic5mNx04UPDxDsZup1lgw9iqjZxRttwkSkMcjDHZ/16uoOxdll/05DfDC90KxVD7meZj9
 AW52lgx5AQQgO5mUt265sEtaRVHEqa00kuFBRqijMOnexhQHeecwLWDa6Zudyqu8bDfI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=0HbpZ5y4KBTMmm6kgEOFcZ79PWJY5Yto/LStdXCr+8o=; b=XeY7geb4R7as
 F9hrWEUVFOUnvpA+FYpRChG5N01VDfCs+YHCAxRqoxQS7LAjCCqK5HyokijyjsQXvDMH3Q4U+W1md
 W5D5FYZ9b4HloHsTDSdoZa6CKe/X0+5Ef4QtbI7IRXmqhmE5KqliGxyAa1NnMNp6LzNViBdaXCQKU
 qiE80=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1qM9Ov-00D4vM-6a for osst-users@lists.sourceforge.net;
 Wed, 19 Jul 2023 15:47:42 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=0HbpZ5y4KBTMmm6kgEOFcZ79PWJY5Yto/LStdXCr+8o=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=0HbpZ5y4KBTMmm6kgEOFcZ79PWJY5Yto/LStdXCr+8o=;
 b=
From: =?UTF-8?B?THVpcyByb2Ryw61ndWV6?= <luis.rodriguez@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_P8EJ0N9tDkep@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_P8EJ0N9tDkep
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=eeed6ew9&token=jwhfhlx5
Feedback-ID: 287535:287535-4576:campaign:IPRPL
Date: Wed, 19 Jul 2023 15:47:41 +0000
X-Spam-Score: 5.3 (+++++)
...
X-Headers-End: 1qM9Ov-00D4vM-6a
...
Content-Type: multipart/mixed; boundary="===============1441673230087455074=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============1441673230087455074==
Content-Type: multipart/related;
 boundary="--==_mimepart_64b805953440e_13fd4c815b91826058bf";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64b805953440e_13fd4c815b91826058bf
Content-Type: multipart/alternative;
 boundary="--==_mimepart_64b80595342e5_13fd4c815b9182605745";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_64b80595342e5_13fd4c815b9182605745
...
@list l0:level9
	...
	text-indent:-18.0pt;}
@list l1
	{mso-list-id:1748186468;
	mso-list-template-ids:81424874;}
ol
	{margin-bottom:0cm;}
ul
	{margin-bottom:0cm;}
...
<img src=3D"https://tr220505813.consultores-rh.com/i/eeed6ew9/jwhfhlx5.gi=

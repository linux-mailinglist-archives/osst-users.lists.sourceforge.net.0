...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 556A36F5CBA
	for <lists+osst-users@lfdr.de>; Wed,  3 May 2023 19:09:44 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1puFz5-0002iR-0J
	for lists+osst-users@lfdr.de;
	Wed, 03 May 2023 17:09:43 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <jassiel.ramirez@consultores-rh.com>)
 id 1puFz3-0002iH-GV for osst-users@lists.sourceforge.net;
 Wed, 03 May 2023 17:09:41 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=nudwg7IvErSO2q83b/1eWwbRQ0w8+rllputC9qBDGiQ=; b=T9RQq/o+S4+97Wko2WeBZ0oBeH
 4CiDEmF1TORMsH48/X4N5cWuEP1m5ltvExDjBbfeJ/xjqQA5b+xi6PMvBI0OojOkYInjLMsWmoZzx
 SqtrFOY8gBwm45bv3DmYTlWOA0ntRbQxXs0GPc9EP9ReFSJv0P3/OEsYamyKL3msCnso=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=nudwg7IvErSO2q83b/1eWwbRQ0w8+rllputC9qBDGiQ=; b=AJzLjl5XQH2Z
 pbXxuy+S48Qwq7e6u0ZGHrveX1ZT3K+VquvHfEGCxPoQSiffe8BAwiX7RctKBX3ommnzbJADLU/LU
 e6ULSHtT6b9cc1/JrGNI9okmmzScjHyD8oZpm5/2GYirWCSsK/+eRFKVtqam+/b0pLyk5jE+YzjmX
 ATM28=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1puFz2-00D6Af-4V for osst-users@lists.sourceforge.net;
 Wed, 03 May 2023 17:09:41 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=nudwg7IvErSO2q83b/1eWwbRQ0w8+rllputC9qBDGiQ=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=nudwg7IvErSO2q83b/1eWwbRQ0w8+rllputC9qBDGiQ=;
 b=
From: =?UTF-8?B?SmFzc2llbCBSYW3DrXJleg==?= <jassiel.ramirez@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_Wv1BWppcowKR@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_Wv1BWppcowKR
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=xj1mdro5&token=bjbp9_is
Feedback-ID: 287535:287535-4435:campaign:IPRPL
Date: Wed, 3 May 2023 17:09:40 +0000
X-Spam-Score: 5.3 (+++++)
...
X-Headers-End: 1puFz2-00D6Af-4V
...
Content-Type: multipart/mixed; boundary="===============5046691568205962162=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============5046691568205962162==
Content-Type: multipart/related;
 boundary="--==_mimepart_6452954c189ce_13fc7b636c654480995c";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_6452954c189ce_13fc7b636c654480995c
Content-Type: multipart/alternative;
 boundary="--==_mimepart_6452954c187ff_13fc7b636c65448098eb";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_6452954c187ff_13fc7b636c65448098eb
...
( https://tr220505813.consultores-rh.com/c/xj1mdro5/bjbp9_is/t_kzqgniqb4 =
)
...
.com/c/xj1mdro5/bjbp9_is/t_kzqgniqb4"><span lang=3D"ES-TRAD" style=3D"mso=
...
<img src=3D"https://tr220505813.consultores-rh.com/i/xj1mdro5/bjbp9_is.gi=

...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id BA82B96566A
	for <lists+osst-users@lfdr.de>; Fri, 30 Aug 2024 06:37:47 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1sjtOM-0003pO-IC
	for lists+osst-users@lfdr.de;
	Fri, 30 Aug 2024 04:37:46 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <www-data@v150-95-84-213.a019.g.bkk1.static.cnode.io>)
 id 1sjtOL-0003pA-3K for osst-users@lists.sourceforge.net;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=4F6b0R3Bd2qs2bKMY/R87zm3hyOl1K8/72I2APvsrmA=; b=cSYuf0+JKNzgP3KRl9AwtmKnif
 fSFp/R2SgTg9898ZhhW0Xr4sBSj+hf/PNqkAocFDJ8fZ7fNDvk0uE+ag3LUVSesX1EijqqfS947aQ
 wHlR20QymlHr9OE0TrXrt10CzNvInYhUKdGMZKjr2Pqnz6mrntnJKW3FxWMWC05i/9TE=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=4F6b0R3Bd2qs2bKMY/R87zm3hyOl1K8/72I2APvsrmA=; b=Q
 C/xOw53LHARx5j+0YJ2IREj2DtUnN8PI8BDpF0BecsmwwhwVEXS9canBuQWF1YY57ADLQwOZu+dXn
 HiMfBjkFkjbqsY7aOr5n9KvyjCwbgMTxdhJ4P6A5zdaaPQY262wBB2JPBfkjiNXrmAgY4pYYhk+xX
 Cwc5DlAElg4oEMyc=;
Received: from v150-95-84-213.a019.g.bkk1.static.cnode.io ([150.95.84.213])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1sjtOJ-0007Ii-SA for osst-users@lists.sourceforge.net;
 Fri, 30 Aug 2024 04:37:45 +0000
Received: by v150-95-84-213.a019.g.bkk1.static.cnode.io (Postfix,
 from userid 33) id ED328B940E; Fri, 30 Aug 2024 11:18:03 +0700 (+07)
To: osst-users@lists.sourceforge.net
MIME-Version: 1.0
From: Magalu <ofertas36@v150-95-84-213.a019.g.bkk1.static.cnode.io>
Message-Id: <20240830041803.ED328B940E@v150-95-84-213.a019.g.bkk1.static.cnode.io>
Date: Fri, 30 Aug 2024 11:18:03 +0700 (+07)
X-Spam-Score: 4.6 (++++)
X-Spam-Report: Spam detection software, running on the system "util-spamd-1.v13.lw.sourceforge.com",
 ...
 ---- ---------------------- --------------------------------------------------
  ...
  0.0 RCVD_IN_DNSWL_BLOCKED  RBL: ADMINISTRATOR NOTICE: The query to
                             ...
                             http://wiki.apache.org/spamassassin/DnsBlocklists#dnsbl-block
                              for more information.
                             [150.95.84.213 listed in list.dnswl.org]
  0.0 RCVD_IN_VALIDITY_RPBL_BLOCKED RBL: ADMINISTRATOR NOTICE: The
                             query to Validity was blocked.  See
                             https://knowledge.validity.com/hc/en-us/articles/20961730681243
                              for more information.
                             [150.95.84.213 listed in bl.score.senderscore.com]
  0.0 RCVD_IN_VALIDITY_CERTIFIED_BLOCKED RBL: ADMINISTRATOR NOTICE:
                             The query to Validity was blocked.  See
                             https://knowledge.validity.com/hc/en-us/articles/20961730681243
                              for more information.
                             [150.95.84.213 listed in sa-accredit.habeas.com]
...
X-Headers-End: 1sjtOJ-0007Ii-SA
Subject: [Osst-users] Desconto do Dia Magalu: Smart TV 4K 50'' Samsung - Por
 Apenas: R$ 1.339, 90 - Smart TV 4K 43'' Samsung - Por Apenas: R$ 1.099,
 05 - Smart TV 4K 32'' Samsung - Por Apenas: R$ 698,
 99 - APROVEITE  - [ 640760714780  ]
...
Content-Type: multipart/mixed; boundary="===============9080221490427626495=="
                    ...
                    <table align=center border=0 cellpadding=0 cellspacing=0 style=max-width:640px;border-collapse:collapse; width=100%>
                        <tbody>
                            <tr>
                                ...
                                <td style=padding-right:0;padding-left:0;padding-top:0;padding-bottom:0;text-align:center;>
                                    <img src=https://s.mlcdn.com.br/banner/campanhas/HomeAPP_C4_1_Campanha_core_ET_15-07-2024_tvs.png border=0 alt style="max-width: 640px;">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <tr style=border-top-width:0;border-bottom-width:0;padding-top:0;padding-bottom:0; valign=top>
                <td valign=top>
                    <table align=center border=0 cellpadding=0 cellspacing=0 style=max-width:640px;border-collapse:collapse; width=100%>
                        ...
                        <center><a style="background-color: #1E90FF;border-radius: 38px;color: #fff !important;border: 3px solid transparent;height: 50px;font-weight: 600;font-size: 16px;text-decoration: none;padding: 4px 34px;" href="https://red.magaluoffs.shop/redirecionando/43/" target="_blank" rel="noopener noreferrer"><span style="color: #000000;">Comprar</span></a></center>
                                                </td>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table align=center border=0 cellpadding=0 cellspacing=0 style="max-width:345px;height: 480px; border-collapse:collapse;" width=320px>
                                        <tbody>
                                            <tr>
                                                <td style="padding-right:0;padding-left:0;padding-top:0;padding-bottom:0;text-align:center; vertical-align: bottom;">
<br>
                                                    <p><a href="https://red.magaluoffs.shop/redirecionando/32/"><img src=https://i.imgur.com/0lZdEoD.png width=270px height=auto border=0 style="vertical-align: middle; max-height: 295px;" alt="Smart TV Full HD LED 43” Samsung 43T5300A"></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-right:10px;padding-left:10px;padding-top:0;padding-bottom:0;text-align:center; vertical-align: middle;"><a href="https://red.magaluoffs.shop/redirecionando/32/" style="font-size: 16px; color: #0083ca; text-decoration: none;"><span style="font-size:18px; color:#3c3c3c;"><b>Smart TV UHD 4k LED 32&rdquo; Samsung T4300 - Wi-Fi - HDR - 2 HDMI - 1 USB, Controle &Uacute;nico</b></span><div style=height:12px;></div><p style="font-size:16px; margin:0; line-height: 1em"> de&nbsp;<s>R$ 1.038,19</s></p><p style="font-size:30px; margin:0; letter-spacing:-3px"><span style="font-size:16px; letter-spacing:-1px"> por&nbsp;R$&nbsp; </span> 698,99 </p><p style="font-size:16px; margin:0; line-height:0.9em">&Agrave; Vista</p></a></td>
                                            </tr>
                                            <tr>
                                                <td style="padding-right:0;padding-left:0;padding-top:0;padding-bottom:0;text-align:center; vertical-align: bottom;" align=center>
                        <center><br><a style="background-color: #1E90FF;border-radius: 38px;color: #fff !important;border: 3px solid transparent;height: 50px;font-weight: 600;font-size: 16px;text-decoration: none;padding: 4px 34px;" href="https://red.magaluoffs.shop/redirecionando/32/" target="_blank" rel="noopener noreferrer"><span style="color: #000000;">Comprar</span></a></center>
                                                </td>
                                                </td>
                                            </tr>
                                        </tbody>

...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 82A2B6A0CB4
	for <lists+osst-users@lfdr.de>; Thu, 23 Feb 2023 16:18:53 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1pVDMy-0006cg-B3
	for lists+osst-users@lfdr.de;
	Thu, 23 Feb 2023 15:18:51 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <valeria.perez@consultores-rh.com>)
 id 1pVDMu-0006cX-No for osst-users@lists.sourceforge.net;
 Thu, 23 Feb 2023 15:18:48 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=CvP+2d1DUkqkAdBj949K7Hx9ZogXTbdVS7JcCJyXCfo=; b=YjES8UNIE2gjgaXPkYgdNAiUse
 Zso58hnD9p1igReTTygMczA+gdodSCKvUUXQ7kFbLUDucSvkCfkgk5/5EiLYnaS0yOLgGLcAd6DNM
 ri+2ejZmbzAEWglGOOIpkcrxO3Caxs3+OyOD4w+CE+G0wCuNeXhrJ7lmp6sakIZabyfI=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Archive; bh=CvP+2d1DUkqkAdBj949K7Hx9ZogXTbdVS7JcCJyXCfo=; b=JrQISGPsxh18
 KemnAQ3hGjEh/TGz3il4n5Qp+iUDCMvfOgKNqYfiIyUqzAcM0b4ulRl2+QeRdY2+Zd+PxIfz3Q6bq
 LN3TIShOpD8wddmDZ+CoKgMnNMDi6+Wjb1kmdDpd7Uhx2PPdMXJXDDqunJLynZ1mpRIdOf7y/C8DG
 2BgrU=;
Received: from gottlieb.r.mx-router-i.com ([212.192.13.59])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pVDMs-00EgV3-GM for osst-users@lists.sourceforge.net;
 Thu, 23 Feb 2023 15:18:47 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipz2;
 ...
 bh=CvP+2d1DUkqkAdBj949K7Hx9ZogXTbdVS7JcCJyXCfo=;
 b=
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; s=ipzs2;
 d=mx-router-i.com; 
 h=From:To:Message-ID:Subject:Mime-Version:Content-Type:
 Content-Transfer-Encoding:List-Unsubscribe:List-Unsubscribe-Post:Date;
 bh=CvP+2d1DUkqkAdBj949K7Hx9ZogXTbdVS7JcCJyXCfo=;
 b=
From: =?UTF-8?B?VmFsZXJpYSBQw6lyZXo=?= <valeria.perez@consultores-rh.com>
To: osst-users@lists.sourceforge.net
Message-ID: <1_64JQ0gJslkDN@tr220505813.consultores-rh.com>
Mime-Version: 1.0
X-SEID: 1_64JQ0gJslkDN
List-Unsubscribe-Post: List-Unsubscribe=One-Click
X-Report-Abuse: Please report abuse for this campaign here:
 https://humansmart1.mx-router-i.com/abuse_reports/new?id=z1j617po&token=pgrumspf
Feedback-ID: 287535:287535-4337:campaign:IPRPL
Date: Thu, 23 Feb 2023 15:18:46 +0000
X-Spam-Score: 6.6 (++++++)
X-Spam-Report: Spam detection software, running on the system "util-spamd-2.v13.lw.sourceforge.com",
 ...
 Content preview:  Hola. ¿Sabes que tienen en común las empresas más exitosas
    del mundo? Según un artículo de The Balance Careers ( https://tr220505813.consultores-rh.com/c/z1j617po/pgrumspf/eaazjtebtxa
    ) , más del 85% [...] 
 ...
 -0.1 DKIM_VALID_AU          Message has a valid DKIM or DK signature from
  ...
  0.0 T_KAM_HTML_FONT_INVALID Test for Invalidly Named or Formatted
                             Colors in HTML
X-Headers-End: 1pVDMs-00EgV3-GM
...
Content-Type: multipart/mixed; boundary="===============0021046694615372958=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============0021046694615372958==
Content-Type: multipart/related;
 boundary="--==_mimepart_63f783ce70973_13fbc2a1ae0203028069";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_63f783ce70973_13fbc2a1ae0203028069
Content-Type: multipart/alternative;
 boundary="--==_mimepart_63f783ce7059e_13fbc2a1ae0203027976";
 charset=UTF-8
Content-Transfer-Encoding: 7bit


----==_mimepart_63f783ce7059e_13fbc2a1ae0203027976
...
( https://tr220505813.consultores-rh.com/c/z1j617po/pgrumspf/eaazjtebtxa =
)
...
a href=3D"https://tr220505813.consultores-rh.com/c/z1j617po/pgrumspf/eaaz=
jtebtxa" target=3D"_blank"><span style=3D"color:windowtext;text-decoratio=
n:none">The Balance Careers</span></a>, m=C3=A1s del 85% de las compa=C3=B1=
...
<img src=3D"https://tr220505813.consultores-rh.com/i/z1j617po/pgrumspf.gi=

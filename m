...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id B97CAA607C5
	for <lists+osst-users@lfdr.de>; Fri, 14 Mar 2025 04:29:54 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-3.v29.lw.sourceforge.com)
	by sfs-ml-3.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <osst-users-bounces@lists.sourceforge.net>)
	id 1tsvkA-0006lJ-5M
	for lists+osst-users@lfdr.de;
	Fri, 14 Mar 2025 03:29:53 +0000
Received: from [172.30.29.66] (helo=mx.sourceforge.net)
 by sfs-ml-3.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <mailing@ml.flashtoner.info>) id 1tsvk7-0006l9-Qz
 for osst-users@lists.sourceforge.net; Fri, 14 Mar 2025 03:29:51 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=84i8O3YcDW25XYDnanzWP8nmLdQPSfO2sDLCbD8OhH0=; b=l9A/0XL4US4uezcE0Ix1SwYqap
 2CPT0o199Iv6uJsRhkckgREMhDaJXZle6BN+9PgMEoQFzI8icIieSZzgQGFDYlOaXL8FH5ONU4esA
 IoKeN5TvZfDDfLE9CRqKGEInYNoVXluPpVmJDN+/BaXEe9ryYUeKW6Wpce+dpiDafAm0=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 List-Owner:List-Archive; bh=84i8O3YcDW25XYDnanzWP8nmLdQPSfO2sDLCbD8OhH0=; b=g
 r14Q5BcQPIidU9RhK5PjrpjfoJyQnK816L2HOHShHxtFiB0PLE2x9+FMPJcwWf7oYzFaTvuNF5G5H
 gopcFG106i3csxbJGk7JH3C3yr5c/yKCzBSywEmRCSlZ47+SEIbmT2AhDCKdBfIddDe/cTjMyjfnz
 JShKODNBLtiEN+TU=;
Received: from ml012-b.dnshigh.com ([193.70.146.181])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1tsvjw-00035N-Dz for osst-users@lists.sourceforge.net;
 Fri, 14 Mar 2025 03:29:51 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 :Resent-Message-ID:In-Reply-To:References:List-Id:List-Help:List-Unsubscribe:
 List-Subscribe:List-Post:List-Owner:List-Archive;
 bh=84i8O3YcDW25XYDnanzWP8nmLdQPSfO2sDLCbD8OhH0=; b=cG5W1x/FUiM7pngNjAEkUJioBk
 ;
Received: from host-87-6-113-85.retail.telecomitalia.it ([87.6.113.85]:62387
 helo=host-79-27-65-32.retail.telecomitalia.it)
 by ml012.dnshigh.com with esmtpa (Exim 4.98.1)
 (envelope-from <mailing@ml.flashtoner.info>)
 id 1tsvjZ-0000000FM3U-3cK7 for osst-users@lists.sourceforge.net;
 Fri, 14 Mar 2025 04:29:17 +0100
MIME-Version: 1.0
From: "Toner Compatibili" <mailing@ml.flashtoner.info>
To: osst-users@lists.sourceforge.net
Date: Fri, 14 Mar 2025 04:29:28 +0100
Message-ID: <1108825387913661031521@DESKTOP-NINSNT7>
...
X-Get-Message-Sender-Via: ml012.dnshigh.com: authenticated_id:
 mailing@ml.flashtoner.info
X-Authenticated-Sender: ml012.dnshigh.com: mailing@ml.flashtoner.info
X-Spam-Score: 6.1 (++++++)
X-Spam-Report: Spam detection software, running on the system "util-spamd-2.v13.lw.sourceforge.com",
 ...
 -0.1 DKIM_VALID             Message has at least one valid DKIM or DK signature
  ...
  1.7 MIXED_HREF_CASE        Has href in mixed case
  2.5 FREEMAIL_FORGED_REPLYTO Freemail in Reply-To, but not From
X-Headers-End: 1tsvjw-00035N-Dz
...
Content-Type: multipart/mixed; boundary="===============4123103949650068886=="
Errors-To: osst-users-bounces@lists.sourceforge.net


--===============4123103949650068886==
Content-Type: multipart/alternative;
	boundary="----=_NextPart_001_125D_04AB3B9E.5FDF7FBF"


------=_NextPart_001_125D_04AB3B9E.5FDF7FBF
